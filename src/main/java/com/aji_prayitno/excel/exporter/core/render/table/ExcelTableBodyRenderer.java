...
public final class ExcelTableBodyRenderer implements BodyRenderer {
	...
	private <T> int renderFromList(RenderContext context, ExcelTableDefinition<T> tableDefinition, int lastRowIndex) {
	...
	private <T> int renderFromStream(RenderContext context, ExcelTableDefinition<T> tableDefinition, int lastRowIndex) {
